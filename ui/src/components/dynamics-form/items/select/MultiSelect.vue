...
.mobile-multi-select {
  ...
  .selected-display {
    ...
    .selected-content {
      ...
      .selected-tags {
        ...
        flex-wrap: wrap;
        gap: 4px;
        .el-tag { border-radius: 4px; font-size: 12px; padding: 2px 6px; }
      }
      
      .placeholder { color: #c0c4cc; font-size: 14px; }
    }
  ...
  .options-panel {
    ...
    animation: mobileCenterExpand 0.4s cubic-bezier(0.16, 1, 0.3, 1);
    
    @media (max-height: 667px) { max-height: 60vh; }
    @media (min-height: 900px) { max-height: 75vh; }
    ...
    .options-header {
      ...
      align-items: center;
      justify-content: space-between;
      span { font-weight: 600; font-size: 16px; color: #333; }
    }
